...
retnullData() {
  return Container(
    child: Padding(
      ...
      child: Center(
        child: Text("Exam Question are not set today please Try after some time!",
            style: new TextStyle(
                color: Colors.white,
                fontWeight: FontWeight.w900,
                fontSize: 25)),
...
class _Body extends State<Body> with TickerProviderStateMixin {
  ...
  DateTime getNextIntervalTime() {
    ...
    DateTime timeOf18 = DateTime(
        currentTime.year, currentTime.month, currentTime.day, 18, 2, 0, 0, 0);
      ...
      child:  Container(
        ...
        child: Padding(
          ...
          Center(
           ...
           SizedBox(height: 50,),
           Text("Please Wait we are getting your Result Ready...",style: TextStyle(
                color: Colors.black,
                fontWeight: FontWeight.bold,
                fontSize: 18,
              ),),

...
class Profileservice {
  var url = Uri.parse("https://3.6.153.237/Comp_Api/ProfileAdd.php");

  var urlDelete = Uri.parse("https://3.6.153.237/Comp_Api/ProfileImgDelete.php");
  ...
  var getContacturl = Uri.parse("https://3.6.153.237/Comp_Api/getprofileContactUs.php");

  var getProAddurl = Uri.parse("https://3.6.153.237/Comp_Api/getProfileAdd.php");
  ...
  var proAddurl = Uri.parse("https://3.6.153.237/Comp_Api/ProfileAddressAdd.php");

  var proContactAddurl = Uri.parse("https://3.6.153.237/Comp_Api/profileContactUsAdd.php");
  ...
  List<ProductMdl> ProductGetJson(List list) {
    ...
    return List<ProductMdl>.from(
        list.map((item) => ProductMdl.fromjson(item)));
  }
  ...
  Future<List> proGet(ProfileModel proAddModel) async {
   ...
   Future<List> proContactGet(ProfileCountactUs proAddModel) async {
    var response = await http.post(getContacturl, body: proAddModel.toJsonProFeth());
    if (response.statusCode == 200) {
  ...
  Future<List> proAddGet(ProfileAddMdl proAddModel) async {
   ...
   Future<List> productGetMaxNo(ProductMdl proAddModel) async {
    var response =
        await Dio().post("https://3.6.153.237/Api/getMaxProductNo.php", 
...
//productAdd
 Future<String> productAdd(ProductMdl proAddModel) async {
  ...
  Future<String> proAdd(ProfileModel proAddModel) async {
    final response = await http.post(url, body: proAddModel.toJsonAdd());
    if (response.statusCode == 200) {
      print("res" + response.body);
      toastPass("Add Sucessfully!");
      return response.body;
   ...
   Future<String> proPicDelete(ProfileModel proAddModel) async {
    final response = await http.post(urlDelete, body: proAddModel.toJsonProFeth());
    if (response.statusCode == 200) {
      print("res" + response.body);
  ...
  Future<String> proAddressAdd(ProfileAddMdl proAddModel) async {
   ...
   Future<String> proContactAdd(ProfileCountactUs proAddModel) async {
    final response = await http.post(proContactAddurl, body: proAddModel.toJsonFeth());
    if (response.statusCode == 200) {
      print("res" + response.body);
      toastPass("Add Sucessfully!");
      return response.body;
